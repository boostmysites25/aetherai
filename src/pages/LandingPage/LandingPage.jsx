            ...
            <div className="relative z-40 px-6 justify-center h-full flex flex-col items-center gap-5 text-center md:max-w-[60rem] mx-auto">
              ...
              {isWebDevelopment ? (
                <h1 className="main-heading text-white leading-tight">
                  Redefining Digital Presence with <br />
                  <span className="text-primary"> AI </span>
                  -Enhanced Websites
                </h1>
              ) : (
        ...
        <div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 py-[5rem] px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              >
                {isWebDevelopment ? "Web Development" : "App Development"} <span className="bg-gradient-to-r from-blue-400 to-primary bg-clip-text text-transparent">Portfolio</span>
              </h1>
              <p
                data-aos="fade-up"
                data-aos-delay="200"
              ...
              >
                {isWebDevelopment 
                  ? "Discover our innovative web development projects that showcase cutting-edge design and functionality."
                  : "Explore our mobile app development projects that deliver exceptional user experiences across platforms."
                }
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              >
                <div className={`w-1 h-8 bg-gradient-to-b ${isWebDevelopment ? 'from-primary to-blue-400' : 'from-blue-400 to-primary'} rounded-full`}></div>
                {isWebDevelopment ? "Featured Web Projects" : "Featured Mobile Apps"}
              </h2>
              <p
                data-aos="fade-up"
            ...
            <SinglePortfolio
              porfolio={
                isWebDevelopment ? webPortfolio : appPortfolio
              }
              portfoliofor=""
              isDark={true}
              isModern={true}
