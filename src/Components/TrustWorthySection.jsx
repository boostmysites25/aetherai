  ...
  return (
    <section className="paddingtop paddingbottom">
      <div className="wrapper text-center">
        ...
        >
          With a dedicated team and a results-driven approach, Aether AI is
        ...
        >
          <div className="relative flex flex-col items-start px-4 lg:px-7 py-2 gap-2 lg:border-l-0 border-gray-400">
            ...
            <p className="text-gray-400 text-xl leading-tight text-start">
              Years of Experience
            </p>
          </div>
          ...
          <div className="relative flex flex-col items-start px-4 lg:px-7 py-2 gap-2 lg:border-l-2 border-gray-400">
            <div className="flex w-full items-center gap-3 justify-between">
              ...
              <div className="w-[5rem] h-[5rem] lg:w-[6rem] lg:h-[6rem] rounded-full bg-primary bg-opacity-20 p-4 flex justify-center items-center">
                <img
                  src={icon3}
                  className="w-[4rem] lg:w-[5rem] object-contain"
                  alt=""
