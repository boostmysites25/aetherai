...
import acheivementbackground from "../assets/images/acheivementbackground.jpg";
const countDetails = [
  {
    id: 1,
...
const CompanyAchievements = () => {
  return (
    ...
    >
      ...
      <div className="wrapper adjustedwidth z-20 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5 py-[6rem]">
        <div className="flex flex-col gap-8 text-white">
          ...
          <h3
            data-aos="fade-up"
            className="text-head text-2xl sm:text-5xl font-bold leading-tight text-white"
          >
            Driving AI Innovation Today, Shaping a Smarter Tomorrow
          </h3>
          <p data-aos="fade-up" className=" text-white/80 text-desc ">
            At Aether AI., we specialize in creating customized technology
