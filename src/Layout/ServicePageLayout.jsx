      ...
      <div className="wrapper">
        <div className="py-[5rem] grid md:grid-cols-[30%_65%] gap-10">
          <div className="w-full flex flex-col gap-10">
            <div className="bg-white shadow-2xl p-4 lg:p-6 rounded-lg">
              <h4 className="text-2xl font-medium text-black">All Services</h4>
            ...
            {/* <div className="text-center bg-blue-300 hidden md:flex flex-col items-start gap-3 px-4 lg:px-6 py-10 rounded-lg">
          ...
          {/* <div className="text-center bg-[#ECF8FF] flex md:hidden flex-col items-start gap-3 px-4 lg:px-6 py-10 rounded-lg">
            <h4 className="text-xl font-semibold">Working Days</h4>
            <div className="flex flex-col gap-3 w-full">
              <Link className="bg-white text-[#17012C] flex items-center gap-2 p-3 rounded-md">
                <BsClock className="text-xl text-primary" />
          ...
          <div className="text-center bg-gradient-to-b flex md:hidden flex-col items-center gap-3 text-white from-[#635AD9] to-[#618cefb1] px-4 lg:px-6 py-10 rounded-lg">
            <div className="w-[3.5rem] h-[3.5rem] bg-white text-primary rounded-full p-3 flex justify-center items-center">
              <FaPhoneAlt className="text-3xl" />
            </div>
